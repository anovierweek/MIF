...
def run_tune(args, tune_times=100):
    ...
    save_file_path = os.path.join(args.res_save_dir, \
                                f'{args.datasetName}-{args.train_mode}-{args.modelName}-{today}.csv')
...
def set_log(args):
    ...
    log_file_path = f'logs/mif-{args.datasetName}-tune.log'
    # set logging
...
def parse_args():
    ...
    parser.add_argument('--res_save_dir', type=str, default='results/20230523',
                        help='path to save results.')
